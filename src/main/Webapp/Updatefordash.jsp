...
<div class="card" style="width: 20rem;margin-top: 20px;border-radius: 10px;">
  ...
  <div class="card-body">
   ...
   <form:form action="updt1" method="post" modelAttribute="upd1" onsubmit="return rolevalidation()">
   <div class="form-row">
   <div class="form-group col-md-6">
   <form:label path="roleName">Role Name :</form:label>
   
   <form:input path="roleName" class="form-control input-sm" name="roleName" id="roleName" readonly="true"/>
